...
class Net {
 public:
  ...
  void set_relu_mask_control(bool on_or_off);
  void reset_all_relu_gates(Dtype on_or_off);
  void set_all_relus_threshold_ratio(Dtype threshold_ratio);
  void set_all_relus_bp_mode(int mode);
