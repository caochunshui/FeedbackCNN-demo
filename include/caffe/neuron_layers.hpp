...
class ReLULayer : public NeuronLayer<Dtype> {
 public:
  ...
  void turn_on_activation(bool flag){
       this->activation_on=flag;
   //    this->no_reshape_flag=flag;
       }
  void set_threshold_ratio(Dtype thd){
       this->threshold_ratio=thd;
   //    this->no_reshape_flag=flag;
       }

  void reset_all_gates(Dtype value);
  void set_bp_mode(int mode){this->bp_mode=mode;}
